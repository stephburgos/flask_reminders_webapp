function animate(selector) {
    ...
    var fireworksFactory = function fireworksFactory() {
        ...
        var color = fromHSL(2 * Math.PI * Math.random(), Math.random(), 0.5);
...
function fillBanner(selector) {
    var text = window.btoa("You did it!!! You're awesome :)")
    //'WW91IGRpZCBpdCEhISBZb3UncmUgYXdlc29tZSA6KQ=='
    $(selector).text(atob(text));
}
